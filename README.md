...
**🔴 [Live dashboard demo](https://21pravi.github.io/Store-Intelligence-System-/)** — static snapshot of real data (no server needed). Run `docker compose up` for the live API-polling version.
